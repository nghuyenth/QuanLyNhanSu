...

{
    public partial class FrmMain : Form
    {
        ...
        private void SuccessLogin(Nhom3_QuanLyNhanSu.Entities.NhanVienLogin nv)
        {
            ...
            switch (nv.LaAdmin)
            {
                case 1:
                    ...
                    break;
                case 2:
                    laAdminRole = "Cán bộ quản lí";
                    break;
                case 3:
                    laAdminRole = "Giảng viên";
                    break;
                default:
                    laAdminRole = "";
                    break;
            }
            lblUserOnline.Text = "Chào Bạn: " + nv.Ho + " " + nv.Ten + "(" + laAdminRole + ")"; NVLG.HoTenNVLG = nv.Ho + " " + nv.Ten;
            NVLG.MaNVLG = nv.MaNV;
        }
        ...
        private void EnableButton(bool b1, bool b2, bool b3, bool b4, bool b5, bool b6, bool b7)
        {
            ...
            if (nvlogin != null && nvlogin.LaAdmin != 1 && nvlogin.LaAdmin != 2)
            {
